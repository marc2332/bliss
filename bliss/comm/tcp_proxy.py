...
def main():      # proxy server part
    ...
    parser.add_argument("--channel-name",dest="channel_name",default=None,
    ...
    channel_name = _options.channel_name or 'proxy:%s:%d' % (_options.host,_options.port)
    channel = Channel(channel_name,
                      value=server_url,callback=channel_cbk)
