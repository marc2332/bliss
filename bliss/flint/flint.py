...
"""
import docopt
from silx.gui.plot.PlotWindow import Plot1D,PlotWindow
...
def flint_channel_update(plot_channel_name):
    ...
    # new plot
    plot_update_cb = functools.partial(plot_update, plot_channel_name=plot_channel_name)
