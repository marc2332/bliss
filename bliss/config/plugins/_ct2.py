...
#      name                          type     possible values   writable   default value         label                     group         description
    ...
    ("clock",                     ('Clock',    None,             True,  card.Clock.CLK_100_MHz, "Clock",                    None,        "counters external clock")),
...
#    ("name",                ('unicode',        None,        True,  "",                          "Name",               None,        "counter name")),
    ("clock source",        ('CtClockSrc',     None,        True,  card.CtClockSrc.CLK_1_25_KHz, "Clock",               "source",    "counter clock source")),
    ("gate source",         ('CtGateSrc',      None,        True,  card.CtGateSrc.GATE_CMPT,     "Gate",                "source",    "counter gate source")),
    ("start source",        ('CtHardStartSrc', None,        True,  card.CtHardStartSrc.SOFTWARE, "Start",               "source",    "hardware start source")),
    ("stop source",         ('CtHardStopSrc',  None,        True,  card.CtHardStopSrc.SOFTWARE,  "Stop",                "source",    "hardware stop source")),
...
#    ("name",            ('unicode',      None,                  True,  "",                          "Name",           None,     "channel name")),
    ("level",           ('Level',        None,                  True,  card.Level.DISABLE,           "Level",          None,     "channel level (TTL, NIM, Auto or None)")),
...
#    ("name",            ('unicode',      None, True,  "",                          "Name",           None,     "channel name")),
    ...
    ("level",           ('Level',        None, True,  card.Level.DISABLE,          "Level",           None,     "channel level (TTL, NIM, Auto or None)")),
    ("source",          ('OutputSrc',    None, True,  card.OutputSrc.SOFTWARE,     "Source",          "source", "output source")),
    ("filter enable",   ('bool',         None, True,  False,                      "Filter enable",   "filter", "output filter enable/disable")),
    ("filter clock",    ('FilterClock',  None, True,  card.FilterClock.CLK_100_MHz,"Filter clock",    "filter", "output filter clock")),
