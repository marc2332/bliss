...
def test_p201():
    ...
    p201_master = P201AcquisitionMaster(
        p201_device, nb_points=100000, acq_expo_time=50e-6)
...
def test_p201_hdf5():
    ...
    p201_device.set_clock(Clock.CLK_100_MHz)
    p201_master = P201AcquisitionMaster(
        p201_device, nb_points=10, acq_expo_time=50e-6)
...
<config>
  <controller class="mockup">
    ...
    p201_device.set_clock(Clock.CLK_100_MHz)
    p201_master = P201AcquisitionMaster(
        p201_device, nb_points=10, acq_expo_time=1e-3)
...
<config>
  <controller class="mockup">
    ...
    test_acq_dev = TestAcquisitionDevice(
        "timer_test", 2, prepare_once=True, start_once=True)
    ascan.add(timer, test_acq_dev)
    test2_acq_dev = TestAcquisitionDevice(
        "timer_test2", 2, prepare_once=True, start_once=True)
