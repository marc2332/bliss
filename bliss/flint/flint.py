...
# Ignore matplotlib warnings generated by silx
# FIXME: Remove it with silx 0.14
...
warnings.filterwarnings(
    "ignore",
    message="Setting the line's pick radius via set_picker is deprecated since 3.3",
)
