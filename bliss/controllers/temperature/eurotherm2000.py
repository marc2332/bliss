...
class Eurotherm2000(object):
    ...
    def identification(self):
        ...
        if ident >> 12 == 2:
            ...
            raise Eurotherm2000Error("Device with identification number %x is not an Eurotherm series 2000 device and cannot be controlled" % (ident))
    ...
    def abort(self):
        if self.sp_status() == 2:
            raise Eurotherm2000Error("Cannot abort, an internal program is running; RESET device first")
    ...
    def _fast_status(self):
        ...
        """
        _status = ["Alarm 1", "Alarm 2", "Alarm 3", "Alarm 4",
                   "Manual mode", "Sensor broken", "Open loop",
                   "Heater fail", "Auto tune active",
                   "Ramp program complete", "PV out of range",
...
class eurotherm2000(Controller):
    ...
    def __init__(self, config, *args):
        ...
        try:
            ...
            port = config['port']
            warn("'port' is deprecated. Use 'serial' instead",
                 DeprecationWarning)
