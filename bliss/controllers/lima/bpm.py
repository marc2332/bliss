...
class Bpm(object):
    ...
    @property
    def y(self):
        return LimaBpmCounter("y", self, self._acquisition_proxy,
                              grouped_read_handler = self._grouped_read_handler)

    @property
    def intensity(self):
        return LimaBpmCounter("intensity", self, self._acquisition_proxy,
                              grouped_read_handler = self._grouped_read_handler)

    @property
    def fwhm_x(self):
        return LimaBpmCounter("fwhm_x", self, self._acquisition_proxy,
                              grouped_read_handler = self._grouped_read_handler)
