...
def test_scalar_types(speedgoat):
    get = xpc.get_param_value_from_name
    assert get(speedgoat, "bool_false_scalar") == False
    assert get(speedgoat, "bool_true_scalar") == True
    assert get(speedgoat, "uint8_scalar") == 23
    assert get(speedgoat, "int8_scalar") == -11
    assert get(speedgoat, "uint16_scalar") == 2300
    assert get(speedgoat, "int16_scalar") == -1100
    assert get(speedgoat, "uint32_scalar") == 230000
    assert get(speedgoat, "int32_scalar") == -110000
    assert get(speedgoat, "single_scalar") == pytest.approx(-2.3e-5)
    assert get(speedgoat, "double_scalar") == pytest.approx(5.43e23)


def test_1d_types(speedgoat):
    get = xpc.get_param_value_from_name

    bool_1d = get(speedgoat, "bool_1d")
    ...
    uint8_1d = get(speedgoat, "uint8_1d")
    ...
    int16_1d = get(speedgoat, "int16_1d")
    ...
    uint32_1d = get(speedgoat, "uint32_1d")
    ...
    int32_1d = get(speedgoat, "int32_1d")
    ...
    single_1d = get(speedgoat, "single_1d")
    ...
    double_1d = get(speedgoat, "double_1d")
...
def test_2d_types(speedgoat):
    get = xpc.get_param_value_from_name

    bool_2d = get(speedgoat, "bool_2d")
    ...
    uint8_2d = get(speedgoat, "uint8_2d")
    ...
    uint16_2d = get(speedgoat, "uint16_2d")
    ...
    int16_2d = get(speedgoat, "int16_2d")
    ...
    uint32_2d = get(speedgoat, "uint32_2d")
    ...
    int32_2d = get(speedgoat, "int32_2d")
    ...
    single_2d = get(speedgoat, "single_2d")
    ...
    double_2d = get(speedgoat, "double_2d")
