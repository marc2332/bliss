"""
This script can be used to run some more demanding scans
using BLISS in library mode.
"""
...
## setup session and recuperate objects that will be used below
test_session = config.get("test_session")
test_session.setup()
robz = test_session.env_dict["robz"]
roby = test_session.env_dict["roby"]
