...
class Keithley428(Device):
    ...
    # Attributes
    # ----------
    @attribute(label='Gain', dtype='int', fisallowed="is_attr_allowed",max_value=10, min_value=0,
    ...
    @attribute(label='Gain', dtype='str', fisallowed="is_attr_allowed",
    ...
    @attribute(label="Rise time string", dtype=str, fisallowed="is_attr_allowed",
