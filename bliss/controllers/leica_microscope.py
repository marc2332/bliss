...
class LeicaMicroscope: 
    ...
    def oscil_prepare(self, start_ang, stop_ang, exp_time,save_diagnostic=False, operate_shutter=False):
    ...
    def oscil(self, start_ang, stop_ang, exp_time,save_diagnostic=False, operate_shutter=False):
      d, calc_velocity, acc_time, acc_ang = self._oscil_calc(start_ang, stop_ang, exp_time)
