...
name2address = dict([
    ...
    ("loop.1.op.ch2onoffhysteresis",     (((0x1673 * 2) + 0x8000,'f'),(0x1673,'h',1))),
    ...
    ("loop.1.op.feedforwardoffset",      (((0x1686 * 2) + 0x8000,'f'),(0x1686,'h',0))),
    ("loop.1.op.feedforwardtrimlimit",   (((0x1687 * 2) + 0x8000,'f'),(0x1687,'h',0))),
    ...
    ("loop.1.pid.proportionalband",      (((0x163b * 2) + 0x8000,'f'),(0x163b,'h',1))),
    ("loop.1.pid.proportionalband2",     (((0x1643 * 2) + 0x8000,'f'),(0x1643,'h',1))),
    ("loop.1.pid.proportionalband3",     (((0x164b * 2) + 0x8000,'f'),(0x164b,'h',1))),
    ...
    ("loop.2.op.ch2onoffhysteresis",     (((0x1773 * 2) + 0x8000,'f'),(0x1773,'h',1))),
    ...
    ("loop.2.op.feedforwardoffset",      (((0x1786 * 2) + 0x8000,'f'),(0x1786,'h',0))),
    ("loop.2.op.feedforwardtrimlimit",   (((0x1787 * 2) + 0x8000,'f'),(0x1787,'h',0))),
    ...
    ("loop.2.pid.proportionalband",      (((0x173b * 2) + 0x8000,'f'),(0x173b,'h',1))),
    ("loop.2.pid.proportionalband2",     (((0x1743 * 2) + 0x8000,'f'),(0x1743,'h',1))),
    ("loop.2.pid.proportionalband3",     (((0x174b * 2) + 0x8000,'f'),(0x174b,'h',1))),
